...
<div style="margin: 20%;">
    <form action="upload" method="POST" enctype="multipart/form-data">
        <div class="mb-3">
            <input type="file" name="excel_file_upload" class="form-control" required style="width: 250px;"
                   accept=".xls,.xlsx"/>
        </div>
...
<div class="toast-container position-fixed bottom-0 end-0 p-3">
    <div id="liveToast" class="toast bg-danger" role="alert" aria-live="assertive" aria-atomic="true">
        <div class="toast-header">
            <img src="<%=request.getContextPath()%>/images/cloud-upload.svg" class="rounded me-2"
                 alt="بارگذاری فایل اکسل">
